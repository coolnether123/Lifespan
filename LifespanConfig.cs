...
namespace Lifespan
{
    ...
    public class LifespanConfig
    {
        ...
        [ModSetting("Adulthood Age (years)", Tooltip = "Age when children transition to adults. Must be higher than Child Start Age Max.", Category = CatLife, Mode = SettingMode.Simple, MinValue = 1, MaxValue = 100, StepSize = 1, SortOrder = 2, ValidateMethod = "CheckAdultAge")]
        public int adultAgeYears = 18;

        [ModSetting("Elder Age (years)", Tooltip = "Age when elder illness and natural death checks begin. Must be higher than Adulthood Age.", Category = CatLife, Mode = SettingMode.Simple, MinValue = 1, MaxValue = 100, StepSize = 1, SortOrder = 3, ValidateMethod = "CheckElderAge")]
        ...
        [ModSetting("Mobility Age (years)", Tooltip = "Age when children become mobile.", Category = CatDevelopment, Mode = SettingMode.Simple, MinValue = 1, MaxValue = 10, StepSize = 1, SortOrder = 31, ValidateMethod = "CheckMobileAge")]
        public int mobileAgeYears = 1;

        [ModSetting("Work Age (years)", Tooltip = "Age when children can perform normal jobs.", Category = CatDevelopment, Mode = SettingMode.Simple, MinValue = 1, MaxValue = 15, StepSize = 1, SortOrder = 32, ValidateMethod = "CheckChildJobAge")]
        public int childJobAgeYears = 6;

        [ModSetting("Expedition Age With Escort", Tooltip = "Minimum age for expeditions when accompanied by a capable adult.", Category = CatDevelopment, Mode = SettingMode.Simple, MinValue = 5, MaxValue = 18, StepSize = 1, SortOrder = 33, ValidateMethod = "CheckExpeditionAccompaniedAge")]
        public int expeditionMinAgeAccompanied = 10;

        [ModSetting("Expedition Age Solo", Tooltip = "Minimum age to lead or go on expeditions without an escort.", Category = CatDevelopment, Mode = SettingMode.Simple, MinValue = 5, MaxValue = 18, StepSize = 1, SortOrder = 34, ValidateMethod = "CheckExpeditionSoloAge")]
        ...
        [ModSetting("Enable Natural Death", Tooltip = "Allow death from old age checks.", Category = CatRisk, Mode = SettingMode.Simple, SortOrder = 50)]
        public bool enableNaturalDeath = true;

        [ModSetting("Natural Death Difficulty", Tooltip = "Higher values increase age-related death risk.", Category = CatRisk, Mode = SettingMode.Simple, MinValue = 0.1f, MaxValue = 5.0f, SortOrder = 51)]
        ...
        [ModSetting("Enable Dementia", Tooltip = "Allow dementia illness rolls.", Category = CatRisk, Mode = SettingMode.Simple, SortOrder = 52)]
        public bool enableDementia = true;

        [ModSetting("Enable Heart Disease", Tooltip = "Allow heart disease illness rolls.", Category = CatRisk, Mode = SettingMode.Simple, SortOrder = 53)]
        public bool enableHeartDisease = true;

        [ModSetting("Enable Arthritis", Tooltip = "Allow arthritis illness rolls.", Category = CatRisk, Mode = SettingMode.Simple, SortOrder = 54)]
        public bool enableArthritis = true;

        [ModSetting("Enable Frailty", Tooltip = "Allow frailty illness rolls.", Category = CatRisk, Mode = SettingMode.Simple, SortOrder = 55)]
        public bool enableFrailty = true;

        [ModSetting("Enable Respiratory Illness", Tooltip = "Allow respiratory illness rolls.", Category = CatRisk, Mode = SettingMode.Simple, SortOrder = 56)]
        public bool enableRespiratory = true;

        [ModSetting("Elder Illness Chance (%/week)", Tooltip = "Base weekly chance for an elder to develop an illness.", Category = CatRisk, Mode = SettingMode.Simple, MinValue = 0f, MaxValue = 5.0f, SortOrder = 57)]
